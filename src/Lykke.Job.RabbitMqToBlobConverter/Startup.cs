...
using Lykke.Job.RabbitMqToBlobConverter.Settings;
using Lykke.Job.RabbitMqToBlobConverter.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.RabbitMqToBlobConverter
{
    [PublicAPI]
    public class Startup
    {
        private const string ApiVersion = "v1";
        private const string ApiName = "RabbitMqToBlobConverter API";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddLykkeLogging(
                    settingsManager.ConnectionString(s => s.RabbitMqToBlobConverterJob.Db.LogsConnString),
                    "RabbitMqToBlobConverterLog",
                    appSettings.SlackNotifications.AzureQueue.ConnectionString,
                    appSettings.SlackNotifications.AzureQueue.QueueName);
                ...
                builder.RegisterModule(new JobModule(appSettings.RabbitMqToBlobConverterJob));
